...
$context['title'] = __('Archive', 'g5_iwi');
if (is_day()) {
    $context['title'] = __('Archive:', 'g5_iwi') . ' ' . get_the_date('j F Y');
} else if (is_month()) {
    $context['title'] = __('Archive:', 'g5_iwi') . ' ' . get_the_date('F Y');
} else if (is_year()) {
    $context['title'] = __('Archive:', 'g5_iwi') . ' ' . get_the_date('Y');
} else if (is_tag()) {
